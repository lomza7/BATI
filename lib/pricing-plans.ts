...
export const PRICING_PLAN_DEFAULTS: PricingPlanDefinition[] = [
  {
    ...
    features: [
      ...
      'Assistant email IA : rédigez vos réponses avec le contexte client',
      'Avis clients : import Google + demandes d\u2019avis par email',
      'Support par email',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Drive documents : tous vos papiers au même endroit',
      'Contacts, calendrier et tâches',
      'Assistant email IA avec contexte client',
      'Avis clients : import Google + demandes d\u2019avis',
      'Support prioritaire',
    ],
