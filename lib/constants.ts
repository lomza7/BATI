export const QUOTE_STATUSES = {
  ...
  envoye: { label: 'Envoyé', color: 'bg-blue-50 text-blue-700' },
  accepte: { label: 'Accepté', color: 'bg-emerald-50 text-emerald-700' },
  refuse: { label: 'Refusé', color: 'bg-red-50 text-red-700' },
  expire: { label: 'Expiré', color: 'bg-amber-50 text-amber-700' },
} as const;
...
export const PROJECT_STATUSES = {
  a_planifier: { label: 'À planifier', color: 'bg-slate-100 text-slate-700' },
  en_cours: { label: 'En cours', color: 'bg-blue-50 text-blue-700' },
  termine: { label: 'Terminé', color: 'bg-emerald-50 text-emerald-700' },
...
export const LEAD_STAGES = {
  ...
  contacte: { label: 'Contacté', color: 'bg-blue-50 text-blue-700' },
  devis_envoye: { label: 'Devis envoyé', color: 'bg-amber-50 text-amber-700' },
  negocie: { label: 'En négo', color: 'bg-orange-50 text-orange-700' },
  gagne: { label: 'Gagné', color: 'bg-emerald-50 text-emerald-700' },
  perdu: { label: 'Perdu', color: 'bg-red-50 text-red-700' },
} as const;

export const CONTRACT_TYPES = {
  chaudiere: { label: 'Chaudière', icon: 'Flame' },
...
export const EXPENSE_CATEGORIES = {
  materiaux: { label: 'Matériaux', color: 'bg-blue-50 text-blue-700' },
  sous_traitance: { label: 'Sous-traitance', color: 'bg-amber-50 text-amber-700' },
  deplacement: { label: 'Déplacement', color: 'bg-emerald-50 text-emerald-700' },
...
export const MEMBER_TYPES = {
  salarie: { label: 'Salarié', color: 'bg-blue-50 text-blue-700' },
  sous_traitant: { label: 'Sous-traitant', color: 'bg-amber-50 text-amber-700' },
  interimaire: { label: 'Intérimaire', color: 'bg-purple-50 text-purple-700' },
} as const;
