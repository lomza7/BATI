...
import { calculerTotaux, formatMontant } from '@/lib/quotes/calculations'
...
export async function generateDevisPdf(
  ...
  text(devis.quote_number, MARGINS.left, PAGE_HEIGHT - 55, { size: 11, color: COLORS.white })
