...
export const FEATURE_DETAILS: FeatureDetail[] = [
  ...
  },
  {
    ...
    subtitle: 'Suivi financier automatisé',
    heroDescription: 'Suivez vos revenus, dépenses et marges avec catégorisation automatique par IA. Hellobat analyse vos opérations et vous donne une vision claire de la santé financière de votre entreprise.',
    sections: [
      {
        title: 'Suivi des dépenses',
        content: 'Enregistrez vos dépenses manuellement ou laissez l\'IA les catégoriser automatiquement : matériaux, sous-traitance, véhicule, assurance, etc. Associez les dépenses à des chantiers pour un suivi projet par projet.',
      },
      {
        title: 'Tableau de bord financier',
        content: 'Visualisez vos revenus, dépenses et marges sur des graphiques clairs. Filtrez par période, par chantier ou par catégorie. Identifiez les projets les plus rentables et ceux qui dépassent le budget.',
      },
      {
        title: 'Rappels fiscaux',
        content: 'Hellobat vous rappelle vos échéances fiscales et sociales : TVA, charges sociales, CFE, DSN. Configurez votre régime fiscal dans les paramètres et recevez des rappels adaptés à votre situation.',
      },
    ],
    highlights: [
      'Catégorisation automatique par IA',
      'Dépenses par chantier',
      'Graphiques revenus/dépenses/marges',
      'Rappels fiscaux personnalisés',
    ],
    plan: 'business',
  },
  {
