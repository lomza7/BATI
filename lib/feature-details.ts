...
export const FEATURE_DETAILS: FeatureDetail[] = [
  ...
  {
    slug: 'calendrier-icloud',
    title: 'Calendrier iCloud',
    subtitle: 'Synchronisation avec iCloud',
    heroDescription: 'Votre calendrier Hellobat se synchronise avec iCloud. Retrouvez tous vos rendez-vous et interventions sur votre iPhone, iPad et Mac — partout où vous êtes.',
    sections: [
      {
        title: 'Synchronisation iCloud',
        content: 'Abonnez-vous à votre calendrier Hellobat depuis l\'app Calendrier d\'Apple (iCloud). Tous vos événements Hellobat apparaissent instantanément sur vos appareils Apple.',
      },
      {
        title: 'Calendrier personnel intégré',
        content: 'Hellobat inclut un calendrier personnel complet : créez, déplacez et organisez vos rendez-vous directement dans l\'app. Vue jour, semaine, mois.',
      },
    ],
    highlights: [
      'Synchronisation iCloud native',
  ...
  },
  {
    ...
    subtitle: 'Rédigez vos réponses en 3 secondes',
    heroDescription: 'Collez l\'email de votre client dans Hellobat, l\'IA génère une réponse professionnelle contextualisée avec les informations client (devis, factures, chantiers). Vous copiez, vous collez dans votre messagerie. C\'est tout.',
    sections: [
      {
        title: 'Réponses IA contextualisées',
        content: 'L\'IA utilise Claude Sonnet pour rédiger des réponses en tenant compte du contexte client : devis en cours, factures impayées, chantiers en cours. Si l\'email vient d\'un client existant, l\'IA est automatiquement reconnaissante de votre historique.',
      },
      {
        title: 'Ton personnalisable',
        content: 'Choisissez le ton de la réponse : professionnel, chaleureux, direct ou commercial. L\'IA adapte le style à votre besoin.',
      },
      {
        title: 'Aucune connexion requise',
        content: 'Pas besoin de connecter votre boîte mail. Copiez-collez l\'email entrant, récupérez la réponse. Votre messagerie reste chez vous.',
      },
    ],
    highlights: [
      'Réponse IA en quelques secondes',
      'Contexte client automatique (devis, factures)',
      'Plusieurs tons disponibles',
      'Aucune connexion de boîte mail',
    ],
    plan: 'pro',
  },
  {
    slug: 'avis-clients',
    title: 'Avis clients',
    subtitle: 'Collectez et affichez vos avis',
