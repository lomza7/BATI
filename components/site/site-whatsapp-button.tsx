...
/** Formats a French phone number to international format for WhatsApp API */
...
export function SiteWhatsappButton({ phone, companyName }: SiteWhatsappButtonProps) {
  const number = formatWhatsappNumber(phone);
  const message = companyName
    ? `Bonjour, je vous contacte depuis votre site ${companyName}. J'aimerais avoir des informations.`
