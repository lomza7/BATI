    ...
    <>
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
        <button
          ...
          className="inline-block text-base sm:text-lg font-semibold px-8 py-3.5 transition-all hover:scale-105"
          style={{
        ...
        {phone && (
          <a
            ...
            className="inline-flex items-center gap-2 text-base sm:text-lg font-semibold px-6 py-3.5 transition-all hover:scale-105"
            style={{
