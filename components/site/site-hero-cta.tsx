    ...
    <>
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 w-full max-w-sm sm:max-w-none mx-auto">
        <button
          ...
          className="w-full sm:w-auto inline-flex items-center justify-center text-base sm:text-lg font-semibold px-6 sm:px-8 py-3.5 transition-all hover:scale-105"
          style={{
        ...
        {phone && (
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 text-base sm:text-lg font-semibold px-6 py-3.5 transition-all hover:scale-105"
            style={{
