    ...
    <div className="fixed inset-0 z-[100] flex flex-col bg-black/90 backdrop-blur-sm">
      ...
      <div className="flex-1 overflow-auto flex justify-center">
        {loading || !previewProfile ? (
          ...
          <div
            className={cn(
              'transition-all duration-300 bg-white shadow-2xl',
              device === 'mobile'
                ? 'w-[390px] my-6 rounded-[2rem] overflow-hidden border-[10px] border-neutral-900 max-w-full'
                : 'w-full'
            )}
            style={device === 'mobile' ? { height: 'calc(100vh - 96px)' } : undefined}
          >
            <div
              data-site-theme={theme}
              className={cn('min-h-full', device === 'mobile' && 'h-full overflow-auto')}
              style={{
