      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-up">
          ...
          <p className="text-base sm:text-lg text-[var(--landing-muted)] mb-5 sm:mb-6 max-w-2xl mx-auto leading-relaxed">
            ...
            <Highlight delay={0.7}>rédige vos réponses email</Highlight> avec le contexte de chaque client,{' '}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="rounded-xl bg-[var(--landing-off)] border border-[var(--landing-border)] p-3">
                    <p className="text-xs font-semibold text-[var(--landing-text)] mb-2">Aujourd&apos;hui</p>
                    <div className="space-y-1.5">
                      <IntegrationRow icon={Calendar} iconBg="bg-blue-50" iconColor="text-blue-600" label="Agenda" sub="3 RDV aujourd'hui" />
                      <IntegrationRow icon={Mail} iconBg="bg-red-50" iconColor="text-red-600" label="Assistant email IA" sub="Réponses prêtes en 3s" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 mt-8 sm:mt-12 text-sm text-[var(--landing-muted)]">
          <span className="flex items-center gap-1.5">
            <svg viewBox="0 0 6 4" className="w-4 h-auto rounded-[1px] ring-1 ring-[var(--landing-border)]" aria-hidden>
              <rect width="2" height="4" fill="#0055A4" />
              <rect x="2" width="2" height="4" fill="#FFFFFF" />
              <rect x="4" width="2" height="4" fill="#EF4135" />
            </svg>
            <strong className="text-[var(--landing-text)]">Fait en France</strong>
          </span>
          ...
          <span className="flex items-center gap-1.5">
            ...
            <strong className="text-[var(--landing-text)]">IA Claude</strong> intégrée
          </span>
          <span className="hidden sm:block w-1 h-1 rounded-full bg-[var(--landing-border)]" />
          <span className="flex items-center gap-1.5">
          ...
          <span className="flex items-center gap-1.5">
            ...
            <strong className="text-[var(--landing-text)]">Paiements Stripe</strong> sécurisés
          </span>
        </div>
      </div>
    </section>
