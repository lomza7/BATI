...
function KpiCard({
  ...
  return (
    <div className="p-3 sm:p-5 rounded-xl bg-[var(--landing-off)] border border-[var(--landing-border)]">
      ...
      <div className="text-lg sm:text-2xl font-semibold text-[var(--landing-text)] mb-0.5 sm:mb-1">{value}</div>
