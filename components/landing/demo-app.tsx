...
const views = [
  ...
  { id: 'plans-rendus', label: 'Avant/Après IA', icon: Paintbrush },
...
function PlansView() {
  const files = [
    ...
    { name: 'Facade — après IA.png', type: 'Image', size: '4.1 MB' },
    { name: 'Salon — avant.jpg', type: 'Image', size: '2.2 MB' },
    { name: 'Salon — après IA.png', type: 'Image', size: '5.2 MB' },
    { name: 'Cuisine — avant.jpg', type: 'Image', size: '3.1 MB' },
    { name: 'Cuisine — après IA.png', type: 'Image', size: '4.8 MB' },
  ];

  return (
    <div>
      <ViewHeader title="Avant/Après IA" count={files.length} />
